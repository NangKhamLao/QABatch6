...
def test_upload_file(login_as_admin):
    ...
    #file input
    file_input = wait.until(EC.presence_of_element_located((By.XPATH, "//input[@type='file']")))
    file_path = os.path.abspath("./resources/Pytest Flag.pdf")
    ...
    #confirm upload
    file_name = wait.until(EC.visibility_of_element_located((By.XPATH, "//div[contains(text(),'Pytest Flag.pdf')]")))
...
def test_download_file(tmp_path):
    ...
    service = Service("/Users/user/Downloads/chromedriver-mac-arm64 3/chromedriver")
