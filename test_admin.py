...
def test_search_admin(login_as_admin):
    ...
    username_edit = wait.until(
        EC.element_to_be_clickable((By.XPATH, "//label[text()='Username']/following::div[1]/input")))
    time.sleep(5)
    ...
    checkbox = wait.until(EC.presence_of_element_located(
        (By.XPATH, "//label[text()='Yes']//following-sibling::input")
    ))
...
def test_delete_admin(login_as_admin):
        pass
